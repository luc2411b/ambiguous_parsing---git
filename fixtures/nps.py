...
TACTILE_INSTRUMENT_NPS = ["pair of gloves", "pair of mittens", "pair of ovenmitts"]
CLOTHING_NPS = ["set of pyjamas", "pair of pants", "sweater", "hat"]
...
PLURAL_NP_TO_SINGULAR = {"pyjamas": "set of pyjamas",
                        "pants": "pair of pants",
                        "pair of binoculars": "pair of binoculars",
